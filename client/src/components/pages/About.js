    ...
    <div className="about-page">
      <SEOTags
        ...
        structuredData={{
          ...
          description:
            "A platform for anonymous validation of behaviors and situations",
        }}
      />
      <h1>About "Is This Normal?"</h1>
      <p className="my-1">
        "Is This Normal?" is a platform where people can anonymously ask if
        their habits, thoughts, or behaviors are normal and get validation from
        the community.
      </p>
      <p className="my-1">
        We all have moments where we wonder if we're the only ones who do
        certain things or think certain thoughts. This platform helps you find
